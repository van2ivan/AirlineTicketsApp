...
{
    /// <inheritdoc />
    public partial class BookingEntities12May2023 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Flight_FlightId = table.Column<int>(type: "int", nullable: true),
                    Flight_FlightNumber = table.Column<int>(type: "int", nullable: true),
                    Flight_DepartureTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Flight_ArrivalTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Flight_ActualDepartureTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Flight_ActualArrivalTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Flight_Company = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Flight_DepartureAirport = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Flight_ArrivalAirport = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "CompletedBookings_FlightsBooked",
                columns: table => new
                {
                    CompletedBookingId = table.Column<int>(type: "int", nullable: false),
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompletedBookings_FlightsBooked", x => new { x.CompletedBookingId, x.Id });
                    table.ForeignKey(
                        name: "FK_CompletedBookings_FlightsBooked_CompletedBookings_CompletedBookingId",
